...
public interface TNoticeDao extends JpaRepository<TNotice, Long> {
	@Query("from TNotice n where n.parentNoticeTypeId=:parentNoticeTypeId and n.published = true and n.state = true")
	public Page<TNotice> getPublishedNoticeList(@Param("parentNoticeTypeId")long parentNoticeTypeId,Pageable pageable);
	
	@Query("from TNotice n where n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	public Page<TNotice> getAllNoticeList(@Param("parentNoticeTypeId")long parentNoticeTypeId,Pageable pageable);
	
	@Query("from TNotice n where n.parentNoticeTypeId=:parentNoticeTypeId and n.published = :published and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :nameKey and n.parentNoticeTypeId = :parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.published = :published and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.noticeDate=:noticeDate and n.published = :published and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.noticeDate=:noticeDate and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.published = :published and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.published = :published and n.noticetypeId=:noticetypeId and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.noticetypeId=:noticetypeId and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.published = :published and n.noticetypeId=:noticetypeId and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.noticetypeId=:noticetypeId and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.published = :published and n.noticetypeId=:noticetypeId and n.noticeDate=:noticeDate and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.noticetypeId=:noticetypeId and n.noticeDate=:noticeDate and n.parentNoticeTypeId=:parentNoticeTypeId and n.state=true")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.published = :published and n.noticeDate=:noticeDate and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.noticeDate=:noticeDate and n.state=true and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.published = :published and n.state=true and n.noticetypeId=:noticetypeId and n.noticeDate=:noticeDate and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey and n.parentNoticeTypeId=:parentNoticeTypeId and n.noticetypeId=:noticetypeId  and n.state=true and n.noticeDate=:noticeDate and n.id in(select nd.noticeId from TNotice_TDepartment nd where nd.departmentId=:departmentId)")
	...
	@Query("from TNotice n where n.title like :namekey  and n.parentNoticeTypeId=:parentNoticeTypeId and (n.published = :publishedLeft or n.published = :publishedRight) and n.state=true and n.noticetypeId = :noticetypeId and (n.publishDate >= :startDate and n.publishDate <= :endDate)")
