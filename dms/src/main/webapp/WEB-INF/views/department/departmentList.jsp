...
dojo.require("dijit.form.DateTextBox");
    ...
    /*set up layout*/
    var layout = [[
      {name: '#', field: 'id', width:"10%", formatter:rowIndexFormatter},
      {name: '科室名称', field: 'name', width:"40%"},
      {name: '负责人', field: 'head', width:"10%"},
      {name: '电话', field: 'telephone', width:"10%"},
	...
	function optionFormatter(id){
		return "<a href=\"<c:url value='/admin/department/edit/'/>"+id+"\">编辑</a>&nbsp;&nbsp;<a href='#' onclick='del("+id+")' >删除</a>";
		}
	
	function del(id){
		if(confirm("删除前请确认该部门下没有用户！")){
			window.location.href="<c:url value='/admin/department/del/'/>"+id;
		}
	}
