...
<link rel="stylesheet"
	href="${ctx }resources/js/dojo-release-1.7.3/dojo/resources/dojo.css" />
<link rel="stylesheet"
	href="${ctx }resources/js/dojo-release-1.7.3/dijit/themes/soria/soria.css" />
<link rel="stylesheet"
	href="${ctx }resources/css/themes/soria/soria.css" />
<link rel="stylesheet" href="${ctx }resources/css/public.css" />


<script type="text/javascript"
	src="${ctx }resources/js/dojo-release-1.7.3/dojo/dojo.js"
	...
	function showFrameDialog(title, url, width, height) {
		var dialog = new dijit.Dialog({
			...
			content : '<iframe src="' + url
					+ '" frameborder="0" scrolling="auto" style="width:'
					+ width + 'px;height:' + (height - 30)
					+ 'px;margin:0;padding:0;overflow:scroll"></iframe>',
			hide : function() {
...
<body class="soria" onload="emergency()">
	...
	<div data-dojo-type="dijit.layout.BorderContainer"
		...
		<div data-dojo-type="dijit.layout.ContentPane"
			...
			%>
			<span
				style="position: absolute; bottom: 1px; right: 10px; margin-bottom: 1px">
				<span style="color: white; font-size: 16px; font-weight: bold; vertical-align: bottom;">
					您好&nbsp;<%=ud.getDepartment().getName()%>&nbsp;
					<%=ud.getName()%>，欢迎使用院内信息共享平台&nbsp;&nbsp;
				</span>
				<button data-dojo-type="dijit.form.Button" onclick="changePW()"
					type="button"
					data-dojo-props="iconClass:'dijitCommonIcon dijitIconKey'"
					style="font-size: 16px; vertical-align: bottom; margin-bottom: 0;">修改密码</button>
				<button data-dojo-type="dijit.form.Button" onclick="logout()"
					type="button"
					data-dojo-props="iconClass:'dijitCommonIcon dijitIconError'"
					style="font-size: 16px; vertical-align: bottom; margin-bottom: 0;">退出</button>
			</span>
		</div>
		...
		<div data-dojo-type="dijit.layout.AccordionContainer"
			...
			<div data-dojo-type="dijit.layout.AccordionPane" title="功能导航"
				...
				<div id="navMenu" data-dojo-type="dijit.Menu" style='width: 100%;'>
					...
					<div data-dojo-type="dijit.MenuItem"
						data-dojo-props='iconClass:"dijitEditorIcon dijitEditorIconPaste",
						onClick:function(){ go("hospMana/list/public"); }'>交流区</div>
		...
		<div id="layout_center" data-dojo-type="dijit.layout.ContentPane"
			...
			<iframe id="content" src="${homeUrl}" scrolling="no" frameborder="0"
